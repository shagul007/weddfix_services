			...
			<div class="row">
				<div class="col-md-12 dashboard-nav">
					<ul class="nav nav-pills nav-justified">
						...
						<li class="active"><a href="my_profile"><i
      ...
      <div class="col-md-12">
        <div class="dashboard-page-head">
          <div class="page-header">
            <h1>My Profile <small>Edit and Update your profile.</small></h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="bg-white pinside40 mb30">
            <s:form cssClass="form-horizontal" name="fileForm" id="fileForm" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <label class="col-md-4 control-label" for="name">Full Name<span class="required">*</span></label>
                  <div class="col-md-8">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                      <input type="text" class="form-control futureCalendar" id="weddingDate" name="wdStr" placeholder="Wedding Date" value="<s:property value="%{myPersonalDetailsBean['weddingDateStr']}" />">
