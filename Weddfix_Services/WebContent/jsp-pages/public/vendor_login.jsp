...
<body>
	<section id="form-container">
		<div class="main-content">
			<s:form cssClass="form" action="vendor_home" name="form"
				id="form" method="post">
				<div class="form-innner-wrraper">
					<div class="form-color-background">
						<%if (ActionContext.getContext().getName() != null) {
						  if ((ActionContext.getContext().getName().equalsIgnoreCase("vendor_logout"))) {%>
						...
						<div class="form-row">
						<a href="vendor_forgot_password">Forgot password ?</a> 
						<span style="color: #000; font-weight: normal;">No account ?</span> <a href="vendor_register">Sign Up.</a>
						</div>
					</div>
				</div>
			</s:form>
