...
import com.weddfix.web.controller.VendorRegisterAction;
...
public class VendorLoginServlet extends HttpServlet {
    ...
    VendorRegisterAction registerAction = new VendorRegisterAction();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	if(email != null) {
        		...
        		String userExist = commonMasterService.checkVendorAlreadyExist(email.toLowerCase());
        		if (userExist != null) {
        			DirectoryVendorProfileFormBean userProfile = registerService
    						.loadVendorProfileByEmail(email);
...
//    			e.printStackTrace();
          ...
          //add CommonDetails
            ...
            List<MyPersonalDetailsFormBean> myPersonalDetails = registerService
					.loadVendorDashBoardDetails(loginFormBean.getId());
			...
			while (itr.hasNext()) {
				...
				if (obj[3] != null) {
					myPersonalDetailsMap.put("fileName", rb.getString("url")+"/ImageAction.action?imageId="+obj[3].toString());
				} else {
					myPersonalDetailsMap.put("fileName", "");
				}
				myPersonalDetailsMap.put("planName", obj[4].toString());
				...
				if (obj[8] != null) {
					myPersonalDetailsMap.put("bookingTotalCount",
							Long.parseLong(obj[8].toString()));
				} else {
					myPersonalDetailsMap.put("bookingTotalCount", 0);
				}
			}
